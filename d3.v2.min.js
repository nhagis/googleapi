(function () {
    ...
    return (
      ...
      (e
        ? 1 +
          Math.floor(
            Math.log(
              e + Math.pow(10, 1 + Math.floor(Math.log(e) / Math.LN10) - t)
            ) / Math.LN10
          )
        : 1)
    );
  ...
  function L(e, t) {
    ...
    return (
      ...
      arguments.length < 1
        ? ((e = 1), (n = t / 4))
        : (n = (t / (2 * Math.PI)) * Math.asin(1 / e)),
      function (r) {
        return (
          1 + e * Math.pow(2, 10 * -r) * Math.sin(((r - n) * 2 * Math.PI) / t)
        );
      }
    );
  }
  ...
  function P(e) {
    ...
    t[0] * n[1] < n[0] * t[1] &&
      ((t[0] *= -1), (t[1] *= -1), (r *= -1), (i *= -1)),
      (this.rotate =
        (r ? Math.atan2(t[1], t[0]) : Math.atan2(-n[0], n[1])) * ls),
  ...
  function $(e, t, n) {
    (e = J(e)), (t = J(t)), (n = J(n));
    var r = ut((0.4124564 * e + 0.3575761 * t + 0.1804375 * n) / ys),
      i = ut((0.2126729 * e + 0.7151522 * t + 0.072175 * n) / bs),
      s = ut((0.0193339 * e + 0.119192 * t + 0.9503041 * n) / ws);
  ...
  function it(e, t, n) {
    ...
    return (
      ...
      (s = ot(s) * ws),
      U(
        at(3.2404542 * i - 1.5371385 * r - 0.4985314 * s),
        at(-0.969266 * i + 1.8760108 * r + 0.041556 * s),
        at(0.0556434 * i - 0.2040259 * r + 1.0572252 * s)
      )
    );
  }
  function st(e, t, n) {
  ...
  function at(e) {
    return Math.round(
      255 * (e <= 0.00304 ? 12.92 * e : 1.055 * Math.pow(e, 1 / 2.4) - 0.055)
    );
  }
  function ft(e) {
    return Qi(e, ks), e;
  ...
  function vt(e) {
    ...
    return function (n, r) {
      ...
      r
        ? ((t.lastIndex = 0),
          t.test(o) ||
            ((o = h(o + " " + e)), s ? (i.baseVal = o) : (n.className = o)))
        : o &&
          ((o = h(o.replace(t, " "))), s ? (i.baseVal = o) : (n.className = o));
    };
  }
  function mt(e, t, n) {
    function r() {
  ...
  function wt(e) {
    return (
      arguments.length || (e = d3.ascending),
      function (t, n) {
  ...
  function Tt(e, t, n) {
    ...
    return (
      ...
      (e.tween = function (t, n) {
        return arguments.length < 2
          ? i.get(t)
          : (n == null ? i.remove(t) : i.set(t, n), e);
      }),
      (e.ease = function (t) {
        return arguments.length
          ? ((o = typeof t == "function" ? t : d3.ease.apply(d3, arguments)), e)
          : o;
      }),
      (e.each = function (t, n) {
        ...
        function (r) {
          return St(e, function (e, u, a) {
            ...
            var h = [],
              ...
              d = e.duration,
              v =
                (e = e.node).__transition__ ||
                (e.__transition__ = { active: 0, count: 0 }),
              m = e.__data__;
  ...
  function Lt() {
    ...
    var r = At() - t;
    r > 24
      ? (isFinite(r) && (clearTimeout(Ws), (Ws = setTimeout(Lt, r))), (zs = 0))
      : ((zs = 1), Xs(Lt));
  }
  function At() {
    var e = null,
    ...
    while (t)
      t.flush
        ? (delete Rs[t.callback.id],
          (t = e ? (e.next = t.next) : (Us = t.next)))
        : ((n = Math.min(n, t.then + t.delay)), (t = (e = t).next));
    return n;
  }
  function Ot(e, t) {
  ...
  function Rt(e, t) {
    return d3.format(
      ",." +
        Math.max(0, -Math.floor(Math.log(It(e, t)[2]) / Math.LN10 + 0.01)) +
        "f"
    );
  }
  function Ut(e, t, n, r) {
  ...
  function Wt(e, t) {
    ...
    return (
      ...
      (n.domain = function (i) {
        return arguments.length
          ? ((t = i[0] < 0 ? Vt : Xt), (r = t.pow), e.domain(i.map(t)), n)
          : e.domain().map(r);
      }),
      (n.nice = function () {
      ...
      (n.tickFormat = function (e, i) {
        ...
        var s = Math.max(0.1, e / n.ticks().length),
  ...
  function Kt(e, t) {
    ...
    return (
      ...
      (n.range = function (e) {
        return arguments.length
          ? ((o = e), (u = 0), (t = { t: "range", a: arguments }), n)
          : o;
      }),
      (n.rangePoints = function (r, s) {
        ...
        return (
          (o = i(e.length < 2 ? (a + f) / 2 : a + (l * s) / 2, l)),
          (u = 0),
  ...
  function sn(e) {
    function t(t) {
      ...
      while (++c < h)
        i.call(this, (p = t[c]), c)
          ? l.push([+d.call(this, p, c), +v.call(this, p, c)])
          : l.length && (o(), (l = []));
  ...
  function pn(e, t) {
    return e.length < 3
      ? an(e)
      : e[0] +
          vn((e.push(e[0]), e), mn([e[e.length - 2]].concat(e, [e[1]]), t));
  }
  function dn(e, t, n) {
  ...
  function gn(e) {
    ...
    Sn(a, o, u);
    while (++t < n)
      (r = e[t]), o.shift(), o.push(r[0]), u.shift(), u.push(r[1]), Sn(a, o, u);
    t = -1;
    while (++t < 2)
      o.shift(), o.push(r[0]), u.shift(), u.push(r[1]), Sn(a, o, u);
    return a.join("");
  }
  function yn(e) {
    ...
    while (++n < r)
      (i = e[n]), s.shift(), s.push(i[0]), o.shift(), o.push(i[1]), Sn(t, s, o);
    return t.join("");
  }
  function bn(e) {
    var t,
  ...
  function Nn(e) {
    ...
    while (++u <= a)
      (s =
        (e[Math.min(a, u + 1)][0] - e[Math.max(0, u - 1)][0]) /
        (6 * (1 + o[u] * o[u]))),
        t.push([s || 0, o[u] * s || 0]);
    return t;
  }
  ...
  function Ln(e) {
    function t(t) {
      ...
      while (++m < g)
        a.call(this, (y = t[m]), m)
          ? (d.push([(x = +b.call(this, y, m)), (T = +w.call(this, y, m))]),
            v.push([+E.call(this, y, m), +S.call(this, y, m)]))
          : d.length && (o(), (d = []), (v = []));
        ...
        for (l = 3; l < p; l++) {
          ...
          if (d == 1)
            for (h = u._pack_prev; h !== c._pack_prev; h = h._pack_prev, m++)
              if (yr(h, f)) break;
          d
            ? (v < m || (v == m && a.r < u.r) ? gr(u, (a = c)) : gr((u = h), a),
              l--)
            : (mr(u, f), (a = f), t(f));
        }
      }
  ...
  function xr(e, t, n) {
    ...
    if (r && (i || s)) {
      ...
      var a = 0.5 + (r - o) / (2 * u),
        f =
          Math.sqrt(Math.max(0, 2 * o * (r + u) - (r -= u) * r - o * o)) /
          (2 * u);
      ...
      (n.parseRows = function (e, t) {
        function n() {
          ...
          if (e.charCodeAt(t) === 34) {
            ...
            return (
              o === 13
                ? ((l = !0), e.charCodeAt(n + 2) === 10 && s.lastIndex++)
                : o === 10 && (l = !0),
          ...
          var a = s.exec(e);
          return a
            ? ((l = a[0].charCodeAt(0) !== u), e.substring(t, a.index))
            : ((s.lastIndex = e.length), e.substring(t));
        }
        var r = {},
          i = {},
          o = [],
  ...
  function ti() {
    function e(e) {
      ...
      return [
        Math.atan2(u, r) / mo,
        Math.atan2(a, Math.sqrt(r * r + u * u)) / mo,
      ];
    }
        ...
        return (
          p == null &&
            (d =
              ...
              Math.sin(
                (p = Math.acos(
                  Math.max(-1, Math.min(1, i * l + r * f * Math.cos(u - t)))
                ))
              )),
          p
        );
    ...
    var n = {
      ...
      r = {
        ...
        createHalfEdge: function (e, t) {
          return { edge: e, side: t, vertex: null, l: null, r: null };
        },
        insert: function (e, t) {
      ...
      i = {
        bisect: function (e, t) {
          var n = { region: { l: e, r: t }, ep: { l: null, r: null } },
            r = t.x - e.x,
            i = t.y - e.y,
            s = r > 0 ? r : -r,
            o = i > 0 ? i : -i;
          return (
            (n.c = e.x * r + e.y * i + (r * r + i * i) * 0.5),
            s > o
              ? ((n.a = 1), (n.b = i / r), (n.c /= r))
              : ((n.b = 1), (n.a = r / i), (n.c /= i)),
            n
        ...
        intersect: function (e, t) {
          ...
          var s = (n.c * r.b - r.c * n.b) / i,
            ...
            f,
            l;
          u.y < a.y || (u.y == a.y && u.x < a.x)
            ? ((f = e), (l = n))
            : ((f = t), (l = r));
          var c = s >= l.region.r.x;
          return (c && f.side === "l") || (!c && f.side === "r")
            ? null
            : { x: s, y: o };
        },
        rightOf: function (e, t) {
          ...
          if (n.a === 1) {
            ...
            if (!u) {
              ...
              (a =
                n.b * (o * o - s * s) < f * s * (1 + (2 * o) / f + n.b * n.b)),
                n.b < 0 && (a = !a);
            }
          } else {
            var l = n.c - n.a * t.x,
  ...
  (d3.map = function (e) {
    ...
    e(r, {
      ...
      forEach: function (e) {
        for (var t in this)
          t.charCodeAt(0) === Yi && e.call(this, t.substring(1), this[t]);
      },
    });
  var Gi = "\0",
    Yi = Gi.charCodeAt(0);
  (d3.functor = u),
    ...
    (d3.median = function (e, t) {
      return (
        arguments.length > 1 && (e = e.map(t)),
        (e = e.filter(f)),
        e.length ? d3.quantile(e.sort(d3.ascending), 0.5) : undefined
      );
    }),
    (d3.min = function (e, t) {
      var n = -1,
    ...
    (d3.nest = function () {
      ...
      function t(e, n) {
        ...
        var r = [],
          o = s[n++],
          u;
        for (u in e) r.push({ key: u, values: t(e[u], n) });
        return (
          o &&
            r.sort(function (e, t) {
  ...
  (d3.round = function (e, t) {
    ...
    (d3.xhr = function (e, t, n) {
      ...
      arguments.length < 3
        ? ((n = t), (t = null))
        : t && r.overrideMimeType && r.overrideMimeType(t),
        r.open("GET", e, !0),
        ...
        (r.onreadystatechange = function () {
          if (r.readyState === 4) {
            var e = r.status;
            n(
              (!e && r.response) || (e >= 200 && e < 300) || e === 304
                ? r
                : null
            );
          }
  ...
  (d3.ns = {
    ...
    qualify: function (e) {
      var t = e.indexOf(":"),
        n = e;
      return (
        t >= 0 && ((n = e.substring(0, t)), (e = e.substring(t + 1))),
        ts.hasOwnProperty(n) ? { space: ts[n], local: e } : e
      );
    },
  }),
  ...
  d3.formatPrefix = function (e, t) {
    ...
    return (
      e &&
        (e < 0 && (e *= -1),
        t && (e = d3.round(e, m(e, t))),
        (n = 1 + Math.floor(1e-12 + Math.log(e) / Math.LN10)),
        (n = Math.max(
          -24,
          Math.min(24, Math.floor((n <= 0 ? n + 1 : n - 1) / 3) * 3)
        ))),
      is[8 + n / 3]
    );
  };
  ...
  (d3.interpolate = function (e, t) {
    ...
    (d3.interpolateString = function (e, t) {
      var n,
        ...
        l;
      hs.lastIndex = 0;
      for (r = 0; (n = hs.exec(t)); ++r)
        n.index && u.push(t.substring(s, (o = n.index))),
          a.push({ i: u.length, x: n[0] }),
          u.push(null),
          (s = hs.lastIndex);
    ...
    (d3.interpolateTransform = function (e, t) {
      ...
      return (
        u[0] != a[0] || u[1] != a[1]
          ? (n.push("translate(", null, ",", null, ")"),
            r.push(
              { i: 1, x: d3.interpolateNumber(u[0], a[0]) },
              { i: 3, x: d3.interpolateNumber(u[1], a[1]) }
            ))
          : a[0] || a[1]
          ? n.push("translate(" + a + ")")
          : n.push(""),
        ...
        p[0] != d[0] || p[1] != d[1]
          ? ((i = n.push(n.pop() + "scale(", null, ",", null, ")")),
            r.push(
              { i: i - 4, x: d3.interpolateNumber(p[0], d[0]) },
              { i: i - 2, x: d3.interpolateNumber(p[1], d[1]) }
            ))
  ...
  (d3.interpolators = [
    ...
    function (e, t) {
      return (
        ...
        d3.interpolateString(e + "", t + "")
      );
    },
    function (e, t) {
      return (
        (typeof t == "string"
          ? ds.has(t) || /^(#|rgb\(|hsl\()/.test(t)
          : t instanceof R) && d3.interpolateRgb(e, t)
      );
    },
    function (e, t) {
  ...
  (ps.brighter = function (e) {
    ...
    return !t && !n && !r
      ...
      : (t && t < i && (t = i),
        ...
        r && r < i && (r = i),
        U(
          Math.min(255, Math.floor(t / e)),
          Math.min(255, Math.floor(n / e)),
          Math.min(255, Math.floor(r / e))
        ));
  }),
    ...
    (d3.hcl = function (e, t, n) {
      return arguments.length === 1
        ? e instanceof et
          ...
          : e instanceof rt
          ? st(e.l, e.a, e.b)
          : st((e = $((e = d3.rgb(e)).r, e.g, e.b)).l, e.a, e.b)
        : Z(+e, +t, +n);
    });
  ...
  (ms.brighter = function (e) {
    return Z(
      this.h,
      this.c,
      Math.min(100, this.l + gs * (arguments.length ? e : 1))
    );
  }),
    (ms.darker = function (e) {
      return Z(
        this.h,
        this.c,
        Math.max(0, this.l - gs * (arguments.length ? e : 1))
      );
    }),
    (ms.rgb = function () {
  ...
  var Ss = function (e, t) {
    ...
    Ns =
      ...
      Ts.mozMatchesSelector ||
      Ts.msMatchesSelector ||
      Ts.oMatchesSelector,
    Cs = function (e, t) {
      return Ns.call(e, t);
    };
    ...
    (ks.selectAll = function (e) {
      ...
      for (var i = -1, s = this.length; ++i < s; )
        for (var o = this[i], u = -1, a = o.length; ++u < a; )
          if ((r = o[u]))
            t.push((n = Ji(e.call(r, r.__data__, u)))), (n.parentNode = r);
      return ft(t);
    }),
    ...
    (ks.insert = function (e, t) {
      function n() {
        return this.insertBefore(
          document.createElementNS(this.namespaceURI, e),
          Ss(t, this)
        );
      }
      function r() {
        return this.insertBefore(
          document.createElementNS(e.space, e.local),
          Ss(t, this)
        );
      }
        ...
        if (t) {
          ...
          for (i = -1; ++i < u; )
            (v = e[i]),
              (m = n[i]),
              v
                ? ((v.__data__ = m), (h[i] = v), (p[i] = d[i] = null))
                : ((p[i] = yt(m)), (h[i] = d[i] = null));
    ...
    (ks.transition = function () {
      ...
      for (var r = -1, i = this.length; ++r < i; ) {
        ...
        for (var s = this[r], o = -1, u = s.length; ++o < u; )
          t.push((n = s[o]) ? { node: n, delay: Bs, duration: js } : null);
      }
  ...
  (Os.call = ks.call),
    ...
    (Os.select = function (e) {
      ...
      for (var s = -1, o = this.length; ++s < o; ) {
        ...
        for (var u = this[s], a = -1, f = u.length; ++a < f; )
          (i = u[a]) && (r = e.call(i.node, i.node.__data__, a))
            ? ("__data__" in i.node && (r.__data__ = i.node.__data__),
              n.push({ node: r, delay: i.delay, duration: i.duration }))
            : n.push(null);
      }
        ...
        for (var u = this[s], a = -1, f = u.length; ++a < f; )
          if ((i = u[a])) {
            ...
            for (var l = -1, c = r.length; ++l < c; )
              n.push({ node: r[l], delay: i.delay, duration: i.duration });
          }
      return Tt(t, this.id, this.time).ease(this.ease());
    }),
    ...
    (Os.attrTween = function (e, t) {
      ...
      function r(e, n) {
        ...
        return r === Is
          ? (this.removeAttributeNS(i.space, i.local), null)
          : r &&
              function (e) {
      ...
      return (
        ...
        this.tween("style." + e, function (r, i) {
          var s = t.call(
            ...
            r,
            i,
            window.getComputedStyle(this, null).getPropertyValue(e)
          );
          return s === Is
            ? (this.style.removeProperty(e), null)
            : s &&
                function (t) {
      ...
      return St(
        ...
        typeof e == "function"
          ? function (t, n, r) {
              t.duration = Math.max(
                1,
                e.call((t = t.node), t.__data__, n, r) | 0
              );
            }
          : ((e = Math.max(1, e | 0)),
            function (t) {
  ...
  (d3.timer = function (e, t, n) {
    ...
    r && r.callback === e
      ? ((r.then = n), (r.delay = t))
      : (Rs[(e.id = ++qs)] = Us = { callback: e, then: n, delay: t, next: Us }),
  ...
  (d3.touches = function (e, t) {
    return (
      arguments.length < 2 && (t = _().touches),
      t
        ? Ji(t).map(function (t) {
            var n = Ot(e, t);
    ...
    (d3.svg.chord = function () {
      function e(e, u) {
        ...
        return (
          "M" +
          a.p0 +
          r(a.r, a.p1, a.a1 - a.a0) +
          (n(a, f)
            ? i(a.r, a.p1, a.r, a.p0)
            : i(a.r, a.p1, f.r, f.p0) +
              r(f.r, f.p1, f.a1 - f.a0) +
              i(f.r, f.p1, a.r, a.p0)) +
          "Z"
        );
      }
  ...
  (d3.svg.axis = function () {
    function e(e) {
      e.each(function () {
        var e = d3.select(this),
          ...
          h =
            f == null ? (t.tickFormat ? t.tickFormat.apply(t, u) : String) : f,
          p = Rn(t, c, l),
    ...
    return (
      ...
      (e.tickSize = function (t, n, o) {
        ...
        return (
          (r = +t), (i = u > 1 ? +n : r), (s = u > 0 ? +arguments[u] : r), e
        );
      }),
    ...
    (d3.svg.brush = function () {
      function e(s) {
        s.each(function () {
          ...
          s
            ...
            c.exit().remove(),
            o &&
              ((h = Dt(o)), f.attr("x", h[0]).attr("width", h[1] - h[0]), n(s)),
            u &&
              ((h = Dt(u)),
              f.attr("y", h[0]).attr("height", h[1] - h[0]),
              r(s)),
            t(s);
        });
      }
      function t(e) {
        e.selectAll(".resize").attr("transform", function (e) {
          return (
            "translate(" + f[+/e$/.test(e)][0] + "," + f[+/^s/.test(e)][1] + ")"
          );
        });
      }
      function n(e) {
      ...
      function i() {
        ...
        function a() {
          d3.event.keyCode == 32 &&
            (S || ((x = null), (T[0] -= f[1][0]), (T[1] -= f[1][1]), (S = 2)),
            M());
        }
        function c() {
          d3.event.keyCode == 32 &&
            S == 2 &&
            ((T[0] += f[1][0]), (T[1] += f[1][1]), (S = 0), M());
        }
        function h() {
          var e = i(),
            s = !1;
          N && ((e[0] += N[0]), (e[1] += N[1])),
            S ||
              (d3.event.altKey
                ? (x ||
                    (x = [(f[0][0] + f[1][0]) / 2, (f[0][1] + f[1][1]) / 2]),
                  (T[0] = f[+(e[0] < x[0])][0]),
                  (T[1] = f[+(e[1] < x[1])][1]))
                : (x = null)),
            w && p(e, o, 0) && (n(y), (s = !0)),
            E && p(e, u, 1) && (r(y), (s = !0)),
            s && (t(y), g({ type: "brush", mode: S ? "move" : "resize" }));
        }
        function p(e, t, n) {
          var r = Dt(t),
            i = r[0],
          ...
          S && ((i -= o), (s -= u + o)),
            ...
            S
              ? (c = (a += o) + u)
              : (x && (o = Math.max(i, Math.min(s, 2 * x[n] - a))),
                o < a ? ((c = a), (a = o)) : (c = o));
          if (f[0][n] !== a || f[1][n] !== c)
        ...
        function d() {
          h(),
            y
              .style("pointer-events", "all")
              .selectAll(".resize")
              .style("display", e.empty() ? "none" : null),
            d3.select("body").style("cursor", null),
            C.on("mousemove.brush", null)
            ...
            : ((t = l || f),
              o &&
                ...
                l ||
                  ((n = f[0][0]),
                  (r = f[1][0]),
                  o.invert && ((n = o.invert(n)), (r = o.invert(r))),
                  r < n && ((a = n), (n = r), (r = a)))),
              u &&
                ((i = t[0][1]),
                (s = t[1][1]),
                l ||
                  ((i = f[0][1]),
                  (s = f[1][1]),
                  u.invert && ((i = u.invert(i)), (s = u.invert(s))),
                  s < i && ((a = i), (i = s), (s = a)))),
              o && u
                ? [
                    [n, i],
    ...
    (d3.behavior.drag = function () {
      ...
      function t() {
        function e() {
          var e = o.parentNode;
          return f
            ? d3.touches(e).filter(function (e) {
        ...
        function t() {
          ...
          (h |= n | r),
            (c = t),
            M(),
            u({ type: "drag", x: t[0] + l[0], y: t[1] + l[1], dx: n, dy: r });
        }
        function i() {
          u({ type: "dragend" }),
            h && (M(), d3.event.target === a && p.on("click.drag", s, !0)),
            p
              .on(f ? "touchmove.drag-" + f : "mousemove.drag", null)
              .on(f ? "touchend.drag-" + f : "mouseup.drag", null);
        }
        function s() {
        ...
        var o = this,
          ...
          p = d3
            .select(window)
            .on(f ? "touchmove.drag-" + f : "mousemove.drag", t)
            .on(f ? "touchend.drag-" + f : "mouseup.drag", i, !0);
        r
          ? ((l = r.apply(o, arguments)), (l = [l.x - c[0], l.y - c[1]]))
          : (l = [0, 0]),
          f || M(),
          u({ type: "dragstart" });
      }
    ...
    (d3.behavior.zoom = function () {
      function e() {
        this.on("mousedown.zoom", o)
          .on("mousewheel.zoom", u)
          .on("mousemove.zoom", a)
          .on("DOMMouseScroll.zoom", u)
          .on("dblclick.zoom", f)
      ...
      function s(e) {
        b &&
          ...
          e({ type: "zoom", scale: d, translate: h });
      }
      function o() {
        function e() {
  ...
  (d3.layout = {}),
    ...
    (d3.layout.chord = function () {
      function e() {
        ...
        while (++m < o) {
          ...
          (i[y] = { index: y, startAngle: v, endAngle: d, value: (d - v) / p }),
            (d += u);
        }
        m = -1;
        while (++m < o) {
    ...
    (d3.layout.force = function () {
      ...
      return (
        (n.tick = function () {
          if ((a *= 0.99) < 0.005)
            return r.end({ type: "end", alpha: (a = 0) }), !0;
          var t = m.length,
            n = g.length,
            i,
            o,
    ...
    (d3.layout.pie = function () {
      function e(s, o) {
        var u = s.map(function (n, r) {
          ...
          f =
            ((typeof i == "function" ? i.apply(this, arguments) : i) - r) /
            d3.sum(u),
          l = d3.range(s.length);
        n != null &&
          l.sort(
  ...
  d3.layout.stack = function () {
    ...
    return (
      ...
      (e.order = function (t) {
        return arguments.length
          ? ((n = typeof t == "function" ? t : ho.get(t) || nr), e)
          : n;
      }),
      (e.offset = function (t) {
        return arguments.length
          ? ((r = typeof t == "function" ? t : po.get(t) || rr), e)
          : r;
      }),
      (e.x = function (t) {
        return arguments.length ? ((o = t), e) : o;
      ...
      if (h > 0) {
        ...
        while (++s < c)
          (d = u[s]),
            d >= a[0] &&
              d <= a[1] &&
              ((l = o[d3.bisect(f, d, 1, h) - 1]), (l.y += p), l.push(e[s]));
      }
      return o;
    }
    var t = !0,
      ...
      function e(e, i) {
        function s(e, t) {
          ...
          if (r && (o = r.length)) {
            ...
            Br(e);
            var p = 0.5 * (a._tree.prelim + c._tree.prelim);
            t
              ? ((i.prelim = t._tree.prelim + n(e, t)), (i.mod = i.prelim - p))
              : (i.prelim = p);
        ...
        function u(e, t, r) {
          if (t) {
            ...
            o && !Or(s) && ((s._tree.thread = o), (s._tree.mod += l - f)),
              i &&
                !Ar(u) &&
                ((u._tree.thread = i), (u._tree.mod += a - c), (r = e));
          }
          return r;
        }
      ...
      return (
        ...
        (s.padding = function (e) {
          function t(t) {
            ...
            return n == null
              ? Ir(t)
              : qr(t, typeof n == "number" ? [n, n, n, n] : n);
          }
          function n(t) {
            return qr(t, e);
          }
  ...
  (d3.geo.azimuthal = function () {
      ...
      var n = e[0] * mo - s,
        ...
        v =
          t === "stereographic"
            ...
            ? 1 / p
            : t === "equidistant"
            ? ((d = Math.acos(p)), d ? d / Math.sin(d) : 0)
            : t === "equalarea"
            ? Math.sqrt(2 / (1 + p))
            : 1,
        m = v * c * l,
    ...
    return (
      (e.invert = function (e) {
        var n = (e[0] - i[0]) / r,
          ...
          h = Math.cos(l);
        return [
          (s + Math.atan2(n * c, f * u * h + o * a * c)) / mo,
          Math.asin(h * a - (f ? (o * c * u) / f : 0)) / mo,
        ];
      }),
      (e.mode = function (n) {
        return arguments.length ? ((t = n + ""), e) : t;
    ...
    (d3.geo.mercator = function () {
      function e(e) {
        ...
        return [t * r + n[0], t * Math.max(-0.5, Math.min(0.5, i)) + n[1]];
      }
      var t = 500,
        n = [480, 250];
      return (
  ...
  (d3.geo.circle = function () {
    ...
    function n(e) {
      ...
      while (++t < n)
        (c = a.distance((f = e[t]))),
          c < u
            ? (o && i.push(ni(o, f)((l - u) / (l - c))),
              i.push(f),
              (s = o = null))
            : ((o = f),
              !s &&
                i.length &&
                (i.push(ni(i[i.length - 1], o)((u - l) / (c - l))), (s = o))),
          (l = c);
      return (
        (s = e[0]),
        (o = i[0]),
    ...
    e.clip = function (e) {
      return (
        typeof s == "function" && a.source(s.apply(this, arguments)),
        f(e) || null
      );
    };
    var f = Ur({
      ...
      MultiPoint: function (e) {
        ...
        return n.length && { type: e.type, coordinates: n };
      },
      LineString: function (e) {
    ...
    return (
      (e.origin = function (t) {
        return arguments.length
          ? ((s = t), typeof s != "function" && a.source(s), e)
          : s;
      }),
      (e.angle = function (t) {
    ...
    (d3.geo.greatArc = function () {
      function e() {
        ...
        return a.push(i), { type: "LineString", coordinates: a };
      }
      var t = Zr,
        n,
        r = ei,
      ...
      return (
        (e.distance = function () {
          return (
            typeof t == "function" && o.source((n = t.apply(this, arguments))),
        ...
        (e.source = function (r) {
          return arguments.length
            ? ((t = r), typeof t != "function" && o.source((n = t)), e)
            : t;
        }),
        (e.target = function (t) {
          return arguments.length
            ? ((r = t), typeof r != "function" && o.target((i = r)), e)
            : r;
        }),
  ...
  (d3.geom.hull = function (e) {
    ...
    for (s = 1; s < t; ++s)
      e[s][1] < e[u][1]
        ? (u = s)
        : e[s][1] == e[u][1] && (u = e[s][0] < e[u][0] ? s : u);
    for (s = 0; s < t; ++s) {
      if (s === u) continue;
      (f = e[s][1] - e[u][1]),
        (a = e[s][0] - e[u][0]),
        r.push({ angle: Math.atan2(f, a), index: s });
    }
    r.sort(function (e, t) {
      ...
      (o = r[s].index),
        d == r[s].angle
          ? ((a = e[p][0] - e[u][0]),
            ...
            a * a + f * f >= l * l + c * c
              ? (r[s].index = -1)
              : ((r[h].index = -1), (d = r[s].angle), (h = s), (p = o)))
          : ((d = r[s].angle), (h = s), (p = o));
    i.push(u);
    for (s = 0, o = 0; s < 2; ++o)
        ...
        (e.clip = function (t) {
          ...
          while (++r < i) {
            ...
            while (++s < o)
              (l = n[s]),
                si(l, u, a)
                  ? (si(f, u, a) || t.push(oi(f, l, u, a)), t.push(l))
                  : si(f, u, a) && t.push(oi(f, l, u, a)),
                (f = l);
            u = a;
          }
          return t;
    ...
    (d3.geom.quadtree = function (e, t, n, r, i) {
      function s(e, t, n, r, i, s) {
        ...
        if (e.leaf) {
          var u = e.point;
          u
            ? Math.abs(u.x - t.x) + Math.abs(u.y - t.y) < 0.01
              ? o(e, t, n, r, i, s)
              : ((e.point = null), o(e, u, n, r, i, s), o(e, t, n, r, i, s))
            : (e.point = t);
        } else o(e, t, n, r, i, s);
      }
  ...
  d3.time.format = function (e) {
    function t(t) {
      ...
      while (++i < n)
        e.charCodeAt(i) == 37 &&
          (r.push(e.substring(s, i), (u = Ro[(o = e.charAt(++i))]) ? u(t) : o),
          (s = i + 1));
    ...
    return (
      (t.parse = function (t) {
        var n = { y: 1900, m: 0, d: 1, H: 0, M: 0, S: 0, L: 0 },
          r = pi(n, e, t, 0);
    ...
    So.forEach(function (e, t) {
      ...
      var n = (d3.time[e] = Hi(
        ...
        function (e) {
          ...
          return (
            Math.floor((d3.time.dayOfYear(e) + ((n + t) % 7)) / 7) - (n !== t)
          );
        }
      ));
      (d3.time[e + "s"] = n.range),
